...
public class EliminarContrato extends javax.swing.JFrame {
     ...
     */
    public EliminarContrato(Controlador control2) {
        control= control2;
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton2.setText("ELIMINAR CONTRATO");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 553, 190, 50));
